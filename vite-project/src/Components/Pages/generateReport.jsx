...
const GenerateReport = () => {
                        ...
                        if (serviceData.serviceStatus) {
                            ...
                            formJson.rows.forEach((row) => {
                                ...
                                row.inputs.forEach((input) => {
                                    ...
                                    //     console.log("Extracted category:", category, " | Extracted key:", key);
                                    ...
                                    //     console.log(`Stored fieldValue: ${fieldValue} under annexure[${category}][${key}]`);
                                    ...
                                    //         serviceData.annexureData.hasOwnProperty(fieldName) &&
                                    //         [0, 1, "0", "1", true, false].includes(serviceData.annexureData[fieldName])
                                    //             ? true
                                    //             : false;

                                    //     console.log(`Determined annexureCheckboxValue for ${annexureCheckboxName}:`, annexureCheckboxValue);

                                    //     annexure[category][annexureCheckboxName] = annexureCheckboxValue;
                                    //     console.log(`Stored annexureCheckboxValue under annexure[${category}][${annexureCheckboxName}]`);
                                    // }else {
                            ...
                            // console.log('Updated annexure after processing rows:', annexure);

                            const category = formJson.db_table;
                            const status = selectedStatuses?.[index] || "";
                            // console.log('Status for this category:', status);

                            const checkboxStatus = selectedCheckbox?.[index] || 0;
                            // console.log('Checkbox status for this category:', checkboxStatus);
 ...
 ${customerInfo.custom_address ? `
    ...
    // console.log('setServicesDataInfo', servicesDataInfo)
                                    ...
                                    <div className="grid md:grid-cols-2 gap-3">
                                        ...
                                        <div className="mb-4">
                                            ...
                                            <input
                                                ...
                                                id="initiation_date"
                                                className=" uppercase w-full border p-2 outline-none rounded-md mt-2"
                            ...
                            <div className="form-group border rounded-md p-3">
                                ...
                                <div className="mb-4">
                                    ...
                                    <input
                                        ...
                                        className="border uppercase w-full rounded-md p-2 mt-2 "
                                ...
                                <div className="mb-4 ">
                                    ...
                                    >
                                        ...
                                        <option value="initiated">INITIATED</option>
                                        <option value="hold">HOLD</option>
                                        <option value="closure_advice">CLOSURE
                                            ADVICE</option>
                                        <option value="wip">WIP</option>
                                        <option value="insuff">INSUFF</option>
                                        <option value="stopcheck">STOPCHECK</option>
                                        <option value="active_employment">
                                            ACTIVE EMPLOYMENT</option>
                                        <option value="nil">NIL</option>
                                        <option value="not_doable">NOT DOABLE</option>
                                        <option value="candidate_denied">
                                ...
                                <div className="grid md:grid-cols-2 gap-3">
                                    <div className="mb-4">
                                        ...
                                        <input
                                            ...
                                            id="report_date"
                                            className="uppercase border rounded-md p-2 w-full mt-2 "
