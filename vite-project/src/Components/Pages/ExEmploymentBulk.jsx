...
const ExEmploymentBulk = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(
                "https://api.screeningstar.co.in/internal-storage/ex-employment/bulk/create",
                {
                    method: "POST",
            ...
            if (response.ok && result.status) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        navigate("/admin-ExEmployements");  // Replace with your route
                    }
                });
    ...
    const handleGoBack = () => {
        navigate('/admin-ExEmployements');
    };

    const csvData = `organization_name,location,verifier_name,designation,mobile_number,email_id,centralized_email_id,verification_name,pricing,turnaround_time,organization_status,industry,standard_process,remark
TechCorp Pvt Ltd,Bangalore,Ravi Kumar,HR Manager,9876543210,ravi.kumar@techcorp.com,hr@techcorp.com,Employment Verification,₹500,2 Days,Active,IT Services,Standard,Verified successfully
GreenField Ltd,Mumbai,Anjali Mehta,Operations Head,9123456789,anjali.mehta@greenfield.com,ops@greenfield.com,Previous Employment Check,₹600,3 Days,Active,Agriculture,Semi-Standard,Delayed response from verifier
SkyHigh Solutions,Delhi,Amit Roy,Team Lead,9988776655,amit.roy@skyhigh.com,team@skyhigh.com,HR Verification,₹450,1 Day,Inactive,Consulting,Standard,Outdated contact info
`;
    ...
    const handleDownload = () => {
        ...
        link.href = url;
        link.setAttribute('download', 'EX-EMPLOYMENT-SAMPLE.csv');
    ...
    return (
        ...
        <div className="bg-[#c1dff2] border border-black" ref={clientEditRef} id="clientedit" >
            <h2 className="text-2xl font-bold py-3 text-left border-b border-b-black  text-[#4d606b] px-3 border"> EX EMPLOYMENT BULK UPLOAD </h2>
...
export default ExEmploymentBulk;
