    ...
    <table class="min-w-full border-collapse border border-gray-400 shadow-md">
        <thead className="bg-[#c1dff2]">
            <tr class=" uppercase text-gray-700 bg-[#c1dff2]">
                ...
                <th class="border border-gray-400 px-4 py-2">Overall Status</th>
            </tr>
        </thead>
        <tbody>
            <tr class="">
                <td class="border border-gray-400 px-4 py-2">
                    ...
                    <input type="date" id="reportDate" name="reportDate" class=" uppercase w-full bg-gray-100 p-2 rounded border-gray-300 mt-2" onChange={handleFilterChange} />
                </td>
                <td class="border border-gray-400 px-4 py-2">
                    ...
                    <input type="date" id="qcDate" name="qcDate" class="uppercase w-full bg-gray-100 p-2 rounded border-gray-300 mt-2" onChange={handleFilterChange} />
                </td>
                <td class="border border-gray-400 px-4 py-2">
                ...
                <td class="border border-gray-400 px-4 py-2">
                    <select id="overall_status" name="overall_status" class="w-full bg-gray-100 p-2 rounded border-gray-300" onChange={handleFilterChange}>
                        <option value="">Select an overall status</option>
                        {tableData.length === 0 || !tableData.some(row => row.overall_status) ? (
                            <option disabled>No data available</option>
                        ) : (
                            tableData
                                .map(row => row.overall_status)
