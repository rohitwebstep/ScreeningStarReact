    ...
    <>
      <div className={`w-full mx-auto ${sectionTabs && sectionTabs.length === 0 ? "bg-white" : ""}`}>
        ...
        <div className="bg-white">
          <div className={`m-auto md:flex items-center w-full md:w-auto  justify-between ${localStorage.getItem('activeTab') !== null ? "mb-16" : "mb-4"}`}>
            <div className="py-3 flex-wrap gap-y-4 flex items-center pb-1">
  ...
  uppercase ${isActive ? "font-bold text-black bg-[#c1dff2]" : " bg-[#d1d1d1] text-[#2c81ba]"
                    ...
                    {openDropdown === tab.key &&
                      ...
                      tab.subMenu.length > 0 && (
                        <div
                          ref={dropdownRef}
                          className={`submenu dropdownmargin flex ${openDropdown === "accountManagement" ? "md:top-[110px] top-[350px]" : ""
