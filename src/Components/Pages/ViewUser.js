...
const DataModal = ({ isOpen, data, onClose }) => {
    ...
    // Function to clean and format JSON data properly
...
const ViewUser = () => {
    ...
    const fetchData = useCallback(() => {
        ...
        const url = `https://api.screeningstar.co.in/user-history/activity?admin_id=${admin_id}&_token=${storedToken}&log_admin_id=${log_admin_id}&log_id=${log_id}`;
