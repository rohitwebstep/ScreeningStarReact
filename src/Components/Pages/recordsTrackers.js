  ...
  return (
    <div className="w-full bg-[#c1dff2] border border-black overflow-hidden">
      <div className="space-y-4 py-[30px] px-[51px] bg-white">
        <div className="border border-gray-400 shadow-lg p-10 w-8/12 mx-auto">
          ...
          <div className="flex space-x-4 items-center justify-center mb-4">
            <div className="flex items-center space-x-4">
              ...
              <select className="border p-2" name="month" value={month} onChange={handleInputChange}>
            ...
            <div className="flex items-center space-x-4">
              ...
              <select className="border p-2" name="year" value={year} onChange={handleInputChange}>
