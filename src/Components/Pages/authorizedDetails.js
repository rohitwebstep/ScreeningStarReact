...
const AuthorizedDetails = () => {
  ...
  return (
    <div className="">
      <div className="bg-white p-12 border w-full border-black mx-auto">
          ...
          <div className="w-2/5">
            <form className="space-y-4 ps-0 pb-[30px] px-[51px] bg-white rounded-md" id="client-spoc" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={loading}
                className={`p-6 py-3 bg-[#2c81ba] hover:scale-105 text-white font-bold rounded-md hover:bg-[#0f5381] transition duration-200 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
              >
                Submit
              </button>
            </form>
