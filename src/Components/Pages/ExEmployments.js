...
const ExEmployements = () => {
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            if (data.data.organizations) {
                setSpocs(data.data.organizations);
            } else {
    ...
    const currentSpocs = spocs
        .filter((spoc) => spoc.organization_name.toLowerCase().includes(searchTerm.toLowerCase()))
    ...
    const filteredSpocs = spocs.filter((spoc) =>
        spoc.organization_name.toLowerCase().includes(searchTerm.toLowerCase())
    );
                    ...
                    <div ref={clientEditRef} className="md:w-2/5">
                        <form className="space-y-4 ps-0 pb-[30px] md:pr-[30px] bg-white rounded-md" id="client-spoc" onSubmit={handleSubmit}>
                            <div className="w-full">
                                <label htmlFor="organization_name" className="block text-left w-full m-auto mb-2 text-gray-700">Organization Name</label>
                                <input
                                    type="text"
                            ...
                            <div className="w-full">
                                <label htmlFor="location" className="block text-left w-full m-auto mb-2 text-gray-700">Location</label>
                                <input
                                    type="text"
                                    name="location"
                            ...
                            <div className="w-full">
                                <label htmlFor="verifier_name" className="block text-left w-full m-auto mb-2 text-gray-700">Verifier Name</label>
                                <input
                                    type="text"
                                    name="verifier_name"
                            ...
                            <div className="w-full">
                                <label htmlFor="centralized_email_id" className='block text-left w-full m-auto mb-2 text-gray-700'>Centralized Email ID</label>
                                <input
                                    type="text"
                                    name="centralized_email_id"
                                    placeholder="Centralized Email ID"
                                    value={formData.centralized_email_id}
                                    onChange={handleChange}
                                    className="w-full m-auto p-3 mb-[20px] border border-gray-300 rounded-md"
                                />
                            </div>
                            ...
                            <div className="w-full">
                                <label htmlFor="verification_name" className='block text-left w-full m-auto mb-2 text-gray-700'>Verification Name</label>
                                <input
                                    type="text"
                            ...
                            <div className="w-full">
                                <label htmlFor="pricing" className='block text-left w-full m-auto mb-2 text-gray-700'>Pricing</label>
                                <input
                                    type="text"
                                    name="pricing"
                                    placeholder="Pricing"
                            ...
                            <div className="w-full">
                                <label htmlFor="turnaround_time" className='block text-left w-full m-auto mb-2 text-gray-700'>Turnaround Time</label>
                                <input
                                    type="text"
                            ...
                            <div className="w-full">
                                <label htmlFor="organization_status" className='block text-left w-full m-auto mb-2 text-gray-700'>Organization Status</label>
                                <input
                                    type="text"
                            ...
                            <div className="w-full">
                                <label htmlFor="industry" className='block text-left w-full m-auto mb-2 text-gray-700'>Industry</label>
                                <input
                                    type="text"
                                    name="industry"
                            ...
                            <div className="w-full">
                                <label htmlFor="standard_process" className='block text-left w-full m-auto mb-2 text-gray-700'>Standard Process</label>
                                <input
                                    type="text"
                            ...
                            <div className="w-full">
                                <label htmlFor="remark" className='block text-left w-full m-auto mb-2 text-gray-700'>Remark</label>
                                <input
                                    type="text"
                                    name="remark"
                                    placeholder="Remark"
                            ...
                            <div className={"flex gap-2 justify-center"}>
                                ...
                                {!isEditing && (
                                    <div className='flex items-center gap-7'>
                                        ...
                                        <button
                                            onClick={() => navigate('/admin-ExEmploymentBulk')}
                                            disabled={loading}
