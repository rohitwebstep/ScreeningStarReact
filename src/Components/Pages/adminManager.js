    ...
    const fetchData = useCallback((filterStatus = null) => {
        ...
        fetch(finalUrl, requestOptions)
            ...
            .catch((error) => {
                ...
                return null;  // Ensure token update is handled in `finally`
            })
            .finally((newToken) => {
                if (newToken) {
                ...
                <div className='flex justify-between items-baseline mb-3' >
                    ...
                    <div className="text-left">
                        <div className="relative w-full">
                            {/* Search input */}
                            <div
                                    className="w-64 rounded-md p-2.5 border border-gray-300 bg-white cursor-pointer capitalize"
                    ...
                    <table className="min-w-full border-collapse border border-black rounded-lg ">
                        <thead>
                            <tr className="bg-[#c1dff2] text-left text-[#4d606b]">
                                ...
                                <th className="uppercase border border-black px-4 py-2 text-center" >View Branches</th>
                            </tr>
                        </thead>
                        {loading ? (
