                                    ...
                                    {filteredData.map((data, index) => (
                                        <React.Fragment key={data.id}>
                                            <tr className="text-center">
                                                ...
                                                <td className="border border-black px-4 py-2">{new Date(data.updated_at).toLocaleDateString()}</td>
                                                <td className="border border-black px-4 py-2">
                                                    <button
                                                    ...
                                                    {(() => {
                                                        ...
                                                        return buttonDisabled ? (
                                                            ...
                                                            <button
                                                                ...
                                                                className={`bg-green-500 uppercase border border-white hover:border-green-500 text-white px-4 py-2 rounded hover:bg-white hover:text-green-500 ${loadingGenrate == index ? 'opacity-50 cursor-not-allowed' : ''} `}
                                                            >
                                                                {buttonText}
                                                            </button>
                                                        );
