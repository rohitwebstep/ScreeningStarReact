...
const ClientSpoc = () => {
  ...
  return (
    ...
    <div className="">
      <div className="bg-white border-black md:p-12 p-6 border w-full mx-auto">
          ...
          <div className="md:w-2/5">
            <form className="space-y-4 ps-0 pb-[30px] px-[51px] bg-white rounded-md" id="client-spoc" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={loading}
                className={`p-6 py-3 bg-[#2c81ba]  text-white font-bold rounded-md hover:bg-[#0f5381] hover:scale-105 transition duration-200 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
              >
                Submit
              </button>
            </form>
