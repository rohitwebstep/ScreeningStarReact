...
const ViewAdminTicket = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('https://api.screeningstar.co.in/ticket/chat', requestOptions);
        ...
        <div className="bg-white border-black border p-6 w-full mx-auto flex flex-col h-screen">
            ...
            <div className="flex items-center space-x-4 p-4 border-t border-gray-300">
                ...
                <button
                    ...
                    className={`bg-blue-500 text-white p-4 rounded-lg hover:bg-blue-600 ${loading ? 'cursor-not-allowed opacity-50' : ''}`}
                    disabled={loading}
                >
