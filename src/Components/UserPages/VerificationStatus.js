...
const VerificationStatus = () => {
  ...
  const { validateBranchLogin, setApiLoadingBranch, apiLoadingBranch } = useApiLoadingBranch();
    ...
    const fetchData = useCallback(() => {
        ...
        let url = `https://api.screeningstar.co.in/branch/report-case-status/list?branch_id=${branch_id}&_token=${token}`;
    ...
    }, [token, setData,]);  // Don't forget to include branchData in the dependency array
...
report.`;
    ...
    console.log('loadinggggggggg2 -', viewLoading);
    console.log('pdfExist2-', pdfExist);
    console.log('ActiveService2-', activeService);
            ...
            <div className="space-y-4 py-[30px] px-[51px] bg-white">
                <div className='flex justify-between items-baseline mb-6 '>
                    <div className=" text-left">
                        <button
                            className="bg-green-500  hover:bg-green-600 hover:scale-105  text-white px-6 py-2 rounded"
                                                    ...
                                                    {(() => {
                                                        ...
                                                        return buttonDisabled ? (
                                                            ...
                                                            <button
                                                                ...
                                                                className={`bg-green-500 uppercase border hover:scale-105 border-white hover:border-green-500 text-white px-4 py-2 rounded hover:bg-white hover:text-green-500 ${loadingGenrate == index ? 'opacity-50 cursor-not-allowed' : ''}`}
                                                            >
                                                                {buttonText}
                                                            </button>
