...
const CandidateManager = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setLoading(false);
        swal("Success!", handleEditClick ? "Form updated successfully." : "Form submitted successfully.", "success");
        fetchCustomerInfo();
        setFormData({
          fullName: '',
          employeeId: '',
        ...
        <form className="space-y-4 w-full pb-16 text-center" onSubmit={handleSubmit}>
          <div className='flex space-x-4'>
            <div className="w-2/5">
              ...
              <div className="w-full">
                <label htmlFor="employeeId" className="block text-left w-full m-auto mb-2 text-gray-700">Employee ID</label>
                <input
                  type="text"
                  name="employeeId"
                    ...
                    {loading ? (
                      ...
                      currentServices.map((service) => (
                        <tr className="text-center whitespace-nowrap" key={service.serviceId}>
                          ...
                          <td className="border px-4 text-left py-2">
