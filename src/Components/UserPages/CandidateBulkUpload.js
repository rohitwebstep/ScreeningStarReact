...
const CandidateBulkUpload = () => {
            ...
            if (response.ok && result.status) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        // Navigate to CandidateManager page
    ...
    return (
        ...
        <div className="bg-[#c1dff2] border border-black" ref={candidateEditRef} id="candidateedit" >
            <h2 className="text-2xl font-bold py-3  border-b border-b-black  text-left text-[#4d606b] px-3 border">CANDIDATE BULK UPLOAD </h2>
                ...
                <form className="space-y-4 w-full text-center" onSubmit={handleSubmit}>
                    <div className='flex space-x-4'>
                            ...
                            <div className='flex justify-center gap-5 mt-10 items-center'>
                                <div>
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className={`p-6 py-3 bg-[#2c81ba]  transition-all duration-200 text-white transform  hover:scale-105 font-bold rounded-md hover:bg-[#0f5381] ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                                    >
                        ...
                        <div className='w-3/5'>
                            ...
                            <div className='p-2.5'>
                                <table className="m-auto w-full border-collapse border rounded-lg border-black ">
                                    <thead>
                                            ...
                                            <>
                                                {currentServices.map((service) => (
                                                    <tr className="text-center" key={service.serviceId}>
                                                        ...
                                                        <td className="border border-black px-4 py-2">
                                                            {service.groupSymbol} {service.serviceIndex + 1}
                                                        </td>
                                                        <td className="border border-black px-4 py-2">{service.serviceTitle}</td>
                                                    </tr>
                                                ))}
                                            </>
                                        )}
