...
const AdminChekin = () => {
    ...
    const generatePDF = async (index, maindata, returnInBlob = false) => {
        ...
        const sideMargin = 10;
        const cyan = [231, 65, 54];
    //    const cyan = [231, 65, 54];  /*  Green  */
        ...
        const titleY = 39;
        doc.setFillColor(...cyan); // [231, 65, 54]
           doc.setDrawColor(161, 45, 37);
        ...
        const backgroundColor = (231, 65, 54);
  ...
  doc.setTextColor(255);
        ...
        const disclaimerButtonXPosition = (doc.internal.pageSize.width - disclaimerButtonWidth) / 2;
           doc.setDrawColor(161, 45, 37); // Border color
        doc.setFillColor(231, 65, 54); // Fill color
