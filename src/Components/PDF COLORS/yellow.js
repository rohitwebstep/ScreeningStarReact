...
const AdminChekin = () => {
    ...
    const generatePDF = async (index, maindata, returnInBlob = false) => {
        ...
        const sideMargin = 10;
        const cyan = [252, 187, 5];
    //    const cyan = [252, 187, 5];  /*  Green  */
        // const cyan = [252, 187, 5];   /*Yellow  */
        // const cyan = [231, 65, 54];  /*Red  */
        // const cyan = [252, 187, 5]; /* Blue  */
        ...
        const titleY = 39;
        doc.setFillColor(...cyan); // [252, 187, 5]
        doc.setDrawColor(176, 130, 3);
       ...
       doc.setFillColor(254, 221, 130);
        ...
        const backgroundColor = (252, 187, 5);
  ...
  doc.setTextColor(255);
        ...
        const disclaimerButtonXPosition = (doc.internal.pageSize.width - disclaimerButtonWidth) / 2;
           doc.setDrawColor(176, 130, 3); // Border color
        doc.setFillColor(252, 187, 5); // Fill color
